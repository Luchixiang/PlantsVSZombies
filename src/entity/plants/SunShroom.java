...
public class SunShroom extends Plant {
    ...
    public void setSmallSunTime(int smallSunTime) {
        this.smallSunTime = smallSunTime;
    }

    public int getSmallSunTime() {
        return smallSunTime;
    }

    public SunShroom(double x, double y, String n) {
        super(x, y, n);
        isSleep = false;
    }
